...
class MainActivity : FlutterActivity(), SensorEventListener {
    ...
    private val OTA_CHANNEL = "com.easyconnect.app/ota_installer"
    private var methodChannel: MethodChannel? = null
    private var otaMethodChannel: MethodChannel? = null
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        otaMethodChannel = MethodChannel(flutterEngine.dartExecutor.binaryMessenger, OTA_CHANNEL)
            ...
            when (call.method) {
                ...
                "installApk" -> {
                    ...
                    try {
                        ...
                        Log.e("MainActivity", "Failed to start package installation intent: ${e.message}", e)
